...
# UART0
#
set_location_assignment PIN_P9 -to uart0_srx_pad_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to uart0_srx_pad_i
set_location_assignment PIN_N11 -to uart0_stx_pad_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to uart0_stx_pad_o
set_location_assignment PIN_R10 -to uart0_vccio_pad_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to uart0_vccio_pad_o
set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT" -to uart0_vccio_pad_o
